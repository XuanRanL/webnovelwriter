...
#### 第三.五层: 主线角色跨章断层监控（2026-04-23 Round 17 新增 · 根治<example-project> Ch3-6 主线角色消失）
...
**错误示例（Ch1-6 <example-project> 全套 checker 漏抓 · 血教训）**：
```
❌ [critical] 简介明示"前三章他要用有限的次数先把妹妹抢回来"
   Ch2 兑现：妹妹<sister-character>翡翠湖校区正面出场 · 带回出租屋
   Ch3-Ch6 锚点：0 次（连 4 章消失）
   → VIOLATION: PROMISE_AFTERMATH_BREAK 主线情感线断裂
   → 修法：Ch7 前 1000 字必须交代现状（电话 / 短信 / 内心提及）

❌ [critical] Ch2 埋设伏笔：深灰夹克男（视线在<protagonist>印记停半秒后离开）
