...
> **引入背景**（2026-04-16）：Ch1 v1 的首句"<protagonist>在死。"是汉语语病（"在死"违反现代汉语体貌），但 19 个审查器（10 内部 + 9 外部）+ Step 6 七层审计 **0 抓**，用户一眼看出"很奇怪"。根因是所有审查器读同一套设定集（含"4 字激活杏仁核"伪科学），规则同源污染导致集体失灵。本 checker 独立运行，不读设定集，纯中文母语本能评估。
...
- 如果作者在开篇策略里说"<protagonist>在死"是激活杏仁核的 S 级首句
...
- `"X 在 + 瞬时动词"`：中文没有"在死""在醒""在倒下"这种进行时表达
  - ❌ "<protagonist>在死。" → ✅ "<protagonist>快死了。"/"<protagonist>正在死去。"/"<protagonist>濒死。"
  - ❌ "李雷在坠落。" → ✅ "李雷正在往下坠。"
- `"X 在 + 抽象名词"`：
  - ❌ "王明在觉醒。" → ✅ "王明醒了。"/"王明觉醒了。"
- 英语语序直译残留：
...
```json
{
  ...
  "first_sentence_analysis": {
    "sentence": "<protagonist>第七次拨通苏灵号码的时候，正跪在合肥地铁二号线大东门站的月台边上。",
