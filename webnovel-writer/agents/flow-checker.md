---
name: flow-checker
description: 读者视角流畅度检查器，一人分饰两角失忆阅读协议。检测 JUMP_LOGIC/MISSING_MOTIVE/UNGROUNDED_TERM/ABRUPT_TRANSITION/VAGUE_REFERENCE/RHYTHM_JOLT/META_BREAK/POV_UNEARNED_KNOWLEDGE 八类读者卡点
...
| **POV_UNEARNED_KNOWLEDGE** | **视角知情权违规** | POV 角色说出的"未来/远处/不可见"情报 X，在本章该句之前无合法载体（档案/系统/对话/证物/感官/亲身记忆）提供 X——读者会问"他凭什么知道？"；开篇章/重生章/穿越章高发区 |
...
### POV_UNEARNED_KNOWLEDGE（Round 12 新增）
**核心定义**：POV 角色（主角/视角角色）在第 N 段的内心独白或对话中说出的信息 X，必须在本章第 N 段之前有**可定位的合法载体**提供：
- 档案/系统提示/金手指灌注（须在 X 之前明确出现）
- 前章已成立的亲身记忆/经历（须属实——前世"没活到"的事件不能写成"前世记得"）
- 本章内的感官观察（看到、听到、摸到）
- 本章内有人告诉他（对话/短信/证物）

**触发信号**（任一命中即标记）：
1. 内心独白出现"N 天后 + 事件名"（如"三十天后末世爆发"/"一周后实验室会爆炸"）且该事件本章之前无载体
2. 内心独白出现"某地 + 现状/未来状态"（"城北基地撑不过第三天"）且该地点本章之前无载体
3. 对话中说出一条未来事件/远处状态，且说话人本章之前没有合法渠道知道
4. 重生/穿越/金手指首章：主角在金手指/档案首次激活**之前**即披露了金手指提供的情报
5. 亲历情景错位：主角"记得"某事，但大纲/前章明确他前世没活到 / 没去过 / 没见过

**Severity 判定**：
- **high**：关键情报（主线金手指/末世/重生核心设定）时序倒置，读者第一印象受损
- **medium**：次级情报（具体数值/人名/时间）时序倒置，读者能猜到但仍卡一下
- **low**：轻微提前透露（几段后就有载体），读者可能忽略

**Ch1《<example-project>》血教训**：L49"三十天后末世爆发，前世他没活到那一天"——<protagonist>前世死于 11:47，根本没活到 30 天后，唯一信息来源"档案灌注"在 L69 才发生。L49 出现"末世爆发"这个未来事件名却没有本章之前的合法载体——**high severity POV_UNEARNED_KNOWLEDGE**。

**与其他类别的区分**：
- vs UNGROUNDED_TERM：UNGROUNDED_TERM 问"术语读者是否看得懂"（3 段内有解释就 OK）；POV_UNEARNED_KNOWLEDGE 问"**角色是否应该知道**"——即使术语在后面解释了，只要角色在当时不应知道，仍违规
- vs JUMP_LOGIC：JUMP_LOGIC 是"推理过程被省略"；POV_UNEARNED_KNOWLEDGE 是"信息根本还没到"
- vs META_BREAK：META_BREAK 是作者声音插入；POV_UNEARNED_KNOWLEDGE 是角色借用作者全知视角

**修复方向**：
1. 调整披露顺序——把载体（档案灌注/系统提示/对话）前置到情报披露之前
2. 改写情报本身——删掉具体未来事件名，只留主角的模糊不安感，等载体到位再揭示
3. 给主角补一个合法来源——前世亲历/目击过某线索，能推出当前判断
